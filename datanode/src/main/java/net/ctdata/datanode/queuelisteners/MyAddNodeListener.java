...
public class MyAddNodeListener extends AddNodeListener {
    ...
    public void HandleMessage(AddNode message) {
        ...
        // Task #1: insert AddNode data into User_Sensors table
        logger.debug("ADD_NODE: Received message from the user "+ message.getUserId());
        ...
        try {
            ...
            if(i == DatanodeConstants.FAILURE)
                ...
                logger.debug("ADD_NODE: Successfully inserted data into the database for the received messgae from the user "+ message.getUserId());
